...
const DB = new Pool({
    ...
    password: "250304me",
    port: 5555      //Porta padrão é 5432 ---- Porta 5555 é a do ELI
})
...
app.get("/allusers", (_, res) => {
    ...
    let SQL = "SELECT usuario_nome, to_char(usuario_data_criacao, 'DD/MM/YYYY'), usuario_status_registro FROM usuarios"
